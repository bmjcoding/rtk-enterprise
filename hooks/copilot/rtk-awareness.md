...
> ⚠️ **Name collision**: If the command set does not match these instructions, you may have `reachingforthejack/rtk`
> (Rust Type Kit) installed instead. Check `which rtk` and reinstall from the approved RTK Enterprise source or package.
