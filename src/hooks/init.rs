...
# Docs: https://github.com/bmjcoding/rtk-enterprise#configuration
schema_version = 1
...
fn run_hook_only_mode(
    ...
    println!("  Note: No RTK.md created. Claude won't know about meta commands such as proxy.");
    ...
    if patch_mode == PatchMode::Skip {
        println!(
            "\nManual setup needed: add RTK hook to {}\n\
             See: https://github.com/bmjcoding/rtk-enterprise#supported-ai-tools",
