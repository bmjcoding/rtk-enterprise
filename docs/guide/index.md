...
- [Configuration](./getting-started/configuration.md) — config.toml, global flags, env vars
- [Troubleshooting](./resources/troubleshooting.md) — common issues and fixes
- [Architecture](../../contributing/ARCHITECTURE.md) — system design for contributors
