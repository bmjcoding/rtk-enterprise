...
1. Open a maintainer application discussion in this repository titled **Maintainer Application: [Your GitHub Handle]**
2. In your application, include:
   ...
   - Your preferred maintainer contact method
...
5. If it's a good fit, we'll continue the conversation through the maintainer channel and guide you through the next steps
